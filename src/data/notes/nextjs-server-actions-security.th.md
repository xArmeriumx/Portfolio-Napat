...
สำหรับระบบ multi-tenant (เช่น แยกร้านด้วย `shopId`) ให้เช็กขอบเขต tenant ทุกครั้ง ดู pattern เต็มที่ [Server Actions + Prisma Transaction](/th/notes/nextjs-prisma-transaction)
